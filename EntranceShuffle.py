...
def connect_exit(world, exitname, entrancename, player):
    ...
    exit.connect(entrance.parent_region, door_addresses[entrance.name][1], exit_ids[exit.name][1], ow_door=entrancename)
...
outlet_ids = {
        "Links House": 0x00,
        "Inverted Links House": 0x00,
        "Chris Houlihan Room": 0x3D,
        "Desert Palace Entrance (South)": 0x0A,
        "Desert Palace Entrance (West)": 0x0C,
        "Desert Palace Entrance (East)": 0x0B,
        "Desert Palace Entrance (North)": 0x0D,
        "Eastern Palace": 0x09,
        "Tower of Hera": 0x2D,
        "Hyrule Castle Entrance (South)": 0x03,
        "Hyrule Castle Entrance (West)": 0x02,
        "Hyrule Castle Entrance (East)": 0x04,
        "Agahnims Tower": 0x25,
        "Inverted Agahnims Tower": 0x25,
        "Thieves Town": 0x35,
        "Skull Woods First Section Door": 0x2B,
        "Skull Woods Second Section Door (East)": 0x2A,
        "Skull Woods Second Section Door (West)": 0x29,
        "Skull Woods Final Section": 0x2C,
        "Ice Palace": 0x2E,
        "Misery Mire": 0x28,
        "Palace of Darkness": 0x27,
        "Swamp Palace": 0x26,
        "Turtle Rock": 0x34,
        "Dark Death Mountain Ledge (West)": 0x16,
        "Dark Death Mountain Ledge (East)": 0x1A,
        "Turtle Rock Isolated Ledge Entrance": 0x19,
        "Hyrule Castle Secret Entrance Stairs": 0x33,
        "Kakariko Well Cave": 0x3A,
        "Bat Cave Cave": 0x12,
        "Elder House (East)": 0x0F,
        "Elder House (West)": 0x0E,
        "North Fairy Cave": 0x39,
        "Lost Woods Hideout Stump": 0x36,
        "Lumberjack Tree Cave": 0x13,
        "Two Brothers House (East)": 0x11,
        "Two Brothers House (West)": 0x10,
        "Sanctuary": 0x01,
        "Old Man Cave (East)": 0x08,
        "Old Man Cave (West)": 0x07,
        "Old Man House (Bottom)": 0x31,
        "Old Man House (Top)": 0x32,
        "Death Mountain Return Cave (West)": 0x2F,
        "Death Mountain Return Cave (East)": 0x30,
        "Spectacle Rock Cave (Bottom)": 0x22,
        "Spectacle Rock Cave": 0x23,
        "Spectacle Rock Cave Peak": 0x24,
        "Paradox Cave (Bottom)": 0x1F,
        "Paradox Cave (Middle)": 0x20,
        "Paradox Cave (Top)": 0x21,
        "Fairy Ascension Cave (Bottom)": 0x1B,
        "Fairy Ascension Cave (Top)": 0x1C,
        "Spiral Cave (Bottom)": 0x1D,
        "Spiral Cave": 0x1E,
        "Bumper Cave (Top)": 0x18,
        "Bumper Cave (Bottom)": 0x17,
        "Superbunny Cave (Top)": 0x15,
        "Superbunny Cave (Bottom)": 0x14,
        "Hookshot Cave": 0x3B,
        "Hookshot Cave Back Entrance": 0x3C,
        "Ganons Tower": 0x38,
        "Inverted Ganons Tower": 0x38,
        "Pyramid Entrance": 0x37,
...
exit_room_ids = {'Links House Exit': 0x0104,
                  'Inverted Big Bomb Shop Exit': 0x0104,
                  'Desert Palace Exit (South)': 0x0084,
                  'Desert Palace Exit (West)': 0x0083,
                  'Desert Palace Exit (North)': 0x0063,
                  'Desert Palace Exit (East)': 0x0085,
                  'Eastern Palace Exit': 0x00c9,
                  'Tower of Hera Exit': 0x0077,
                  'Hyrule Castle Exit (South)': 0x0061,
                  'Hyrule Castle Exit (West)': 0x0060,
                  'Hyrule Castle Exit (East)': 0x0062,
                  'Inverted Pyramid Exit': 0x0010,
                  'Agahnims Tower Exit': 0x00e0,
                  'Inverted Ganons Tower Exit': 0x00e0,
                  'Thieves Town Exit': 0x00db,
                  'Skull Woods First Section Exit': 0x0058,
                  'Skull Woods Second Section Exit (East)': 0x0057,
                  'Skull Woods Second Section Exit (West)': 0x0056,
                  'Skull Woods Final Section Exit': 0x0059,
                  'Ice Palace Exit': 0x000e,
                  'Misery Mire Exit': 0x0098,
                  'Palace of Darkness Exit': 0x004a,
                  'Swamp Palace Exit': 0x0028,
                  'Turtle Rock Exit (Front)': 0x00d6,
                  'Turtle Rock Ledge Exit (West)': 0x0023,
                  'Turtle Rock Ledge Exit (East)': 0x0024,
                  'Turtle Rock Isolated Ledge Exit': 0x00d5,
                  'Hyrule Castle Secret Entrance Exit': 0x0055,
                  'Kakariko Well Exit': 0x002f,
                  'Bat Cave Exit': 0x00e3,
                  'Elder House Exit (East)': 0x00f3,
                  'Elder House Exit (West)': 0x00f2,
                  'North Fairy Cave Exit': 0x0008,
                  'Lost Woods Hideout Exit': 0x00e1,
                  'Lumberjack Tree Exit': 0x00e2,
                  'Two Brothers House Exit (East)': 0x00f5,
                  'Two Brothers House Exit (West)': 0x00f4,
                  'Sanctuary Exit': 0x0012,
                  'Old Man Cave Exit (West)': 0x00f0,
                  'Old Man Cave Exit (East)': 0x00f1,
                  'Old Man House Exit (Bottom)': 0x00e4,
                  'Old Man House Exit (Top)': 0x00e5,
                  'Death Mountain Return Cave Exit (East)': 0x00e7,
                  'Death Mountain Return Cave Exit (West)': 0x00e6,
                  'Spectacle Rock Cave Exit (Peak)': 0x00ea,
                  'Spectacle Rock Cave Exit (Top)': 0x00fa,
                  'Spectacle Rock Cave Exit': 0x00f9,
                  'Paradox Cave Exit (Bottom)': 0x00ff,
                  'Paradox Cave Exit (Middle)': 0x00ef,
                  'Paradox Cave Exit (Top)': 0x00df,
                  'Fairy Ascension Cave Exit (Bottom)': 0x00fd,
                  'Fairy Ascension Cave Exit (Top)': 0x00ed,
                  'Spiral Cave Exit (Top)': 0x00ee, 
                  'Spiral Cave Exit': 0x00fe,
                  'Bumper Cave Exit (Bottom)': 0x00fb,
                  'Bumper Cave Exit (Top)': 0x00eb,
                  'Superbunny Cave Exit (Top)': 0x00e8,
                  'Superbunny Cave Exit (Bottom)': 0x00f8,
                  'Hookshot Cave Exit (South)': 0x003c,
                  'Hookshot Cave Exit (North)': 0x002c,
                  'Ganons Tower Exit': 0x000c,
                  'Inverted Agahnims Tower Exit': 0x000c,
                  'Pyramid Exit': 0x0010,
                  'Waterfall of Wishing': 0x0114,
                   # single exit
                  'Dam': 0x010b,
                  'Blinds Hideout': 0x0119,
                  'Bonk Fairy (Light)': 0x0126,
                  'Lake Hylia Fairy': 0x0115,
                  'Light Hype Fairy': 0x0115,
                  'Desert Fairy': 0x0115,
                  'Kings Grave': 0x0113,
                  'Tavern North': 0x0103,
                  'Chicken House': 0x0108,
                  'Aginahs Cave': 0x010a,
                  'Sahasrahlas Hut': 0x0105,
                  'Cave Shop (Lake Hylia)': 0x0112,
                  'Capacity Upgrade': 0x0115,
                  'Blacksmiths Hut': 0x0121,
                  'Sick Kids House': 0x0102,
                  'Lost Woods Gamble': 0x0100,
                  'Fortune Teller (Light)': 0x0122,
                  'Snitch Lady (East)': 0x0101,
                  'Snitch Lady (West)': 0x0101,
                  'Bush Covered House': 0x0103,
                  'Tavern (Front)': 0x0103,
                  'Light World Bomb Hut': 0x0107,
                  'Kakariko Shop': 0x011f,
                  'Cave 45': 0x011b,
                  'Graveyard Cave': 0x011b,
                  'Checkerboard Cave': 0x0126,
                  'Mini Moldorm Cave': 0x0123,
                  'Long Fairy Cave': 0x011e,
                  'Good Bee Cave': 0x0120,
                  '20 Rupee Cave': 0x0125,
                  '50 Rupee Cave': 0x0124,
                  'Ice Rod Cave': 0x0120,
                  'Bonk Rock Cave': 0x0124,
                  'Library': 0x0107,
                  'Potion Shop': 0x0109,
                  'Hookshot Fairy': 0x010c,
                  'Pyramid Fairy': 0x0116,
                  'East Dark World Hint': 0x010e,
                  'Palace of Darkness Hint': 0x011a,
                  'Dark Lake Hylia Fairy': 0x0115,
                  'Dark Lake Hylia Ledge Fairy': 0x0115,
                  'Dark Lake Hylia Ledge Spike Cave': 0x0125,
                  'Dark Lake Hylia Ledge Hint': 0x010e,
                  'Hype Cave': 0x011e,
                  'Bonk Fairy (Dark)': 0x0126,
                  'Brewery': 0x0106,
                  'C-Shaped House': 0x011c,
                  'Chest Game': 0x0106,
                  'Dark World Hammer Peg Cave': 0x0127,
                  'Red Shield Shop': 0x0110,
                  'Dark Sanctuary Hint': 0x0112,
                  'Inverted Dark Sanctuary': 0x0112,
                  'Fortune Teller (Dark)': 0x0122,
                  'Dark World Shop': 0x010f,
                  'Dark World Lumberjack Shop': 0x010f,
                  'Dark World Potion Shop': 0x010f,
                  'Archery Game': 0x0111,
                  'Mire Shed': 0x010d,
                  'Dark Desert Hint': 0x0114,
                  'Dark Desert Fairy': 0x0115,
                  'Spike Cave': 0x0117,
                  'Cave Shop (Dark Death Mountain)': 0x0112,
                  'Dark Death Mountain Fairy': 0x0115,
                  'Mimic Cave': 0x010c,
                  'Big Bomb Shop': 0x011c,
                  'Inverted Links House': 0x011c,
                  'Dark Lake Hylia Shop': 0x010f,
                  'Lumberjack House': 0x011f,
                  'Lake Hylia Fortune Teller': 0x0122,
                  'Kakariko Gamble Game': 0x0118}
